...
from specvqgan.modules.losses.perceptual_from_fairseq import LPAPS_fairseq
...
class VQLPAPSWithDiscriminator_fairseq(nn.Module):
    def __init__(self, disc_start, codebook_weight=1.0, pixelloss_weight=1.0,
        ...
        self.perceptual_loss = LPAPS_fairseq().eval()
        ...
        print(f"VQLPAPSWithDiscriminator_fairseq running with {disc_loss} loss.")
...
class VQLPAPSWithDiscriminator1dFeats_fairseq(VQLPAPSWithDiscriminator_fairseq):
    def __init__(self, disc_start, codebook_weight=1.0, pixelloss_weight=1.0,
                 disc_num_layers=3, disc_in_channels=3, disc_factor=1.0, disc_weight=1.0,
                 perceptual_weight=1.0, use_actnorm=False, disc_conditional=False,
                 disc_ndf=64, disc_loss="hinge", min_adapt_weight=0.0, max_adapt_weight=1e4):
...
class VQLPAPSWithDiscriminator1dSpecs_fairseq(VQLPAPSWithDiscriminator_fairseq):
    def __init__(self, disc_start, codebook_weight=1.0, pixelloss_weight=1.0,
                 disc_num_layers=3, disc_in_channels=3, disc_factor=1.0, disc_weight=1.0,
                 perceptual_weight=1.0, use_actnorm=False, disc_conditional=False,
                 disc_ndf=64, disc_loss="hinge", min_adapt_weight=0.0, max_adapt_weight=1e4):
...
if __name__ == '__main__':
    ...
    loss = VQLPAPSWithDiscriminator_fairseq(**loss_config)
